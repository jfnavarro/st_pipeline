...
def demultiplex(id_filepath, reads, output_path ,  bc_offset=0, bc_len=27,alignment_method='h_distance_based',local_dist_measure='hamming',kmer_length=9,max_local_distance=3,max_global_distance=9):
    ...
    if alignment_method=='kmer_method':
        ...
        res_writer(res_list, output_path)
                
    return res_list


def res_writer(res_list,resfile_path):
    #writes the output file. All lines contains the \n character
    outfile=open(resfile_path,'w')
    for l in res_list:
        outfile.write(l)
    outfile.close()
...
if __name__=='__main__':
    ...
    parser.add_option("-a", "--alignment_method", dest="alignment_method", default="kmer_method")
...
#     """ lines for testing pre pars"""
    reads='/Users/hosseinshahrabifarahani/Documents/ST_experiments/input_files/raw_reads/miseqf1/1000_sample.fastq'
    ...
    output_path='/Users/hosseinshahrabifarahani/Documents/ST_experiments/output_findindexes/testout.csv'
    demultiplex(id_filepath, reads, output_path, 0, 27, 'kmer_method', 'hamming', 9, 3, 9)

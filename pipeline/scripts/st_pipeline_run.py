...
def main(argv):
    ...
    parser.add_argument('--ref-annotation', default="",help="Path to the reference annotation file (htseq requires a GTF file annotation file that you want to use to annotate")
    parser.add_argument('--expName', default="", help="Name of the experiment (output file name)")
    ...
    parser.add_argument('--bin-path', default="", help="Path to folder where binary executables are present (system path by default)")
